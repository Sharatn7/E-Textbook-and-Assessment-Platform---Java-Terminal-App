...
public class AddNewChapter {
    ...
    public static void addNewChapter(Scanner scanner,String courseId) {
    	...
    	String textbookId = getTextbookId(courseId);
        ...
        try {
            ...
            if (conn != null) {
                ...
                pstmt.setString(1, textbookId);    // Set textbook_id
    ...
    public static String getTextbookId(String courseId) {
        ...
        try (Connection connection = DBConnect.getConnection();
            ...
            try (ResultSet resultSet = statement.executeQuery()) {
                if (resultSet.next()) {
                	textbook_id = resultSet.getString("textbook_id");
                }
            }
