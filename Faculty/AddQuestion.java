...
public class AddQuestion {
    ...
    public static void addQuestion(Scanner scanner,String activityId) {
            ...
            for (int i = 0; i < 4; i++) {
                ...
                if(scanner.nextLine().toLowerCase().equals("correct"))
                	ans=i+1;
            }
            while (true) {
                System.out.println("\n=== Add Question Menu ===");
                ...
                switch (choice) {
                    case 1:
                        ...
                        boolean success = saveQuestionToDatabase(activityId,questionNum, questionText, options, explanations, ans);
                        if (success) {
    	 ...
    	 private static boolean saveQuestionToDatabase(String activityId,String questionNum, String questionText, String[] options, String[] explanations, int ans) {
    		...
    		try {
        		...
        		if(e.toString().contains("Duplicate"))
        		{
        			...
        			addQuestion(new Scanner(System.in),activityId);
        		}
        	    e.printStackTrace();
        	    return false;
        	} 
