...
public class AddActivity {
	...
	public static void addActivity(String tb_id,String chap_id,String section_id, String block_num) {
		System.out.println(section_id+" "+block_num);
        
    	System.out.println("Activity management for "+block_num);
        ...
        while (true) {
            ...
            System.out.println("\n=== Add Activity Menu for "+activity_num+" of "+block_num+"===");
	...
	// Placeholder method for saving text content to the database
	 private static boolean saveActivityToDatabase(String textbook_id,String chapter_id,String section_id,String block_num,String activity_num) {
