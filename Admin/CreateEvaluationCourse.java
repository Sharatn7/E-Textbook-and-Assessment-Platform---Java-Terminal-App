...
public class CreateEvaluationCourse {
    ...
    public static void createNewEvaluationCourse() {
        ...
        String tb_id = CreateActiveCourse.getNewTextbookInstanceId(etextbookId);
        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                    ...
                    if (CreateActiveCourse.createTextbook(tb_id, etextbookId) && saveEvaluationCourseToDatabase(courseId, courseName, tb_id, facultyId, startDate, endDate)) {
    ...
    private static boolean saveEvaluationCourseToDatabase(String courseId, String courseName, String etextbookId, String facultyId,
