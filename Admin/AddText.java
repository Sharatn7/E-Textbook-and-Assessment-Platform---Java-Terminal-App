...
public class AddText {
	private static Scanner scanner = new Scanner(System.in);
	 public static void addText(String tb_id,String chap_id,String section_id, String block_num) {
         ...
         while (true) {
             ...
             switch (choice) {
                 case 1:
                     ...
                     boolean success = saveTextToDatabase(tb_id,chap_id,section_id,block_num,content);
                     if (success) {
 ...
 private static boolean saveTextToDatabase(String textbook_id,String chapter_id,String section_id,String block_num,String content) {
