...
public class ModifyContentBlock {
    ...
    public static void modifyContentBlock(Scanner scanner,String sectionId) {
        ...
        while (inModifyContentBlock) {
            ...
            switch (choice) {
                ...
                case 4:
                	deleteContentBlock(scanner, contentBlockId);
               	    AddText.addText(scanner,sectionId,contentBlockNum);  // Add Picture functionality
                    break;
                case 5:
        ...
        try {
            ...
            if (conn != null) {
                ...
                if (rowsDeleted > 0) {
                    ...
                    System.out.println("Failed to delete content block. Content block ID may not exist.");
                }
            }
        } catch (SQLException e) {
            e.printStackTrace();
    ...
    public static void deleteActivity(Scanner scanner, String contentBlockId) {
        ...
        try {
            ...
            if (conn != null) {
                String query = "DELETE FROM Activity WHERE content_block_id = ?";
                pstmt = conn.prepareStatement(query);
                pstmt.setString(1, contentBlockId);
                ...
                if (rowsDeleted > 0) {
                    ...
                    System.out.println("Failed to delete activities. Content block ID may not exist.");
                }
            }
        } catch (SQLException e) {
            e.printStackTrace();
