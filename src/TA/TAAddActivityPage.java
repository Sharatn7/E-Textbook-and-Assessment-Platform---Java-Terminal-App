...
public class TAAddActivityPage {
        ...
        while (!exit) {
            ...
            switch (option) {
                case 1 -> {
                    ...
                    String contentBlockId = getOrCreateContentBlock(contentBlockNumber, sectionId);
    ...
    private String getOrCreateContentBlock(String contentBlockNumber, String sectionId) {
        ...
        if (contentBlockId == null) {
            contentBlockId = insertNewContentBlock(contentBlockNumber, sectionId);
        }
    ...
    private String insertNewContentBlock(String contentBlockNumber, String sectionId) {
