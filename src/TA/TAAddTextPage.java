...
public class TAAddTextPage {
    ...
    public void showAddTextPage(Scanner scanner, String contentBlockNumber, String sectionId) {
        boolean exit = false;
        ...
        while (!exit) {
            ...
            switch (option) {
                case 1 -> {
                    String contentBlockId = addContentBlockIfNotExist(contentBlockNumber, sectionId, textContent);
                    if (contentBlockId != null) {
                        System.out.println("Text saved successfully" + contentBlockId);
                    } else {
                        System.out.println("Failed to save text. Content Block ID may already exist. Please try again.");
                    }
                    exit = true;
                }
                case 2 -> {
    ...
    private String addContentBlockIfNotExist(String contentBlockNumber, String sectionId, String textContent) {
        ...
        String sqlInsert = "INSERT INTO ContentBlocks (section_id, content_block_number, content_type, content_data, createdby) VALUES (?, ?, 'text', ?, 'TA')";
        ...
        try (Connection conn = DBConnect.getConnection();
            ...
            insertStatement.setString(3, textContent);
            ...
            System.out.println("Database error while adding content block: " + e.getMessage());
        }
