...
public class CreateContentBlock {
	private static Scanner scanner = new Scanner(System.in);
	 public static void createNewContentBlock(int tb_id,String chap_id,String section_id) {
		 System.out.print("Enter Unique Content Block ID: ");
         String block_num = "Block"+scanner.nextInt();
