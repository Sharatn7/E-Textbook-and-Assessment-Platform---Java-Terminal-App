...
public class CreateSection {
	...
	public static void createNewSection(int tb_id,String chapter_id) {  
    	// Step 1: Take input for Section details
        System.out.print("Enter Section Number: ");
        String section_num = "Sec"+scanner.nextInt();
   ...
   public static boolean saveSectionToDatabase(int tb_id,String chapter_id,String section_num, String sectionTitle) {
