...
public class ModifyContentBlock {
	...
	public static void modifyContentBlock(int textbookId, String chapterId, String sectionNumber) {
        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                	...
                	AddText.addText(textbookId,chapterId,sectionNumber,contentBlockId);
                    break;
                case 2:
                    // Redirect to Add Picture
                	AddPicture.addPicture(textbookId,chapterId,sectionNumber,contentBlockId);
                    break;
                case 3:
                    // Redirect to Add New Activity
                	AddActivity.addActivity(textbookId,chapterId,sectionNumber,contentBlockId);
                    break;
                case 4:
                    // Discard the input and go back to the previous page
                    System.out.println("Going back to the previous page...");
                    ModifySection.modifySection(textbookId,chapterId);
                    return;
                case 5:
